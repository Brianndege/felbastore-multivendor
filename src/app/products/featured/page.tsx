...
export default async function FeaturedItemsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="mb-4 text-3xl font-bold text-[#e16b22]">Featured Items</h1>
      <p className="mb-8 text-gray-600">Top products from verified live vendors.</p>
          ...
          <Card key={product.id} className="overflow-hidden">
            ...
            <CardContent className="p-4">
              ...
              <div className="mt-2 flex gap-2 text-xs">
                ...
                <span className="ml-auto text-gray-500">★{product.avgRating ? Number(product.avgRating).toFixed(1) : "-"}</span>
              </div>
            </CardContent>
          </Card>
        ))}
